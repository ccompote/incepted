...
wp-cli.phar config create --dbname="$WP_DB_NAME" --dbuser="$WP_DB_USR" --dbpass="$WP_DB_PASS" --dbhost="$DB_HOSTNAME" --path="/var/www/html/wordpress" --force --skip-check --allow-root
